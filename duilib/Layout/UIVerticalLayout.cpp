...
namespace DuiLib
{
	...
	void CVerticalLayoutUI::SetPos(RECT rc)
	{
		...
		if( m_pHorizontalScrollBar && m_pHorizontalScrollBar->IsVisible() ) 
			szAvailable.cx += m_pHorizontalScrollBar->GetScrollRange();//这里的逻辑应该不对! jian.he 2018/03/09 16:49;
...
//			cyFixedRemaining -= m_iChildPadding;
	...
	void CVerticalLayoutUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
		...
		else if(0 == _tcscmp(pstrName, _T("vscrollbarwidth")))//jian.he added 2018/03/09 17:41;
		{
			if(m_pVerticalScrollBar)
				m_pVerticalScrollBar->SetFixedWidth(_ttoi(pstrValue));
		}
